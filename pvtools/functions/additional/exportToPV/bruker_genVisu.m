...
% All Rights Reserved
%
% $Id: bruker_genVisu.m,v 1.2 2013/05/24 13:29:27 haas Exp $
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if ~isempty(path_to_imagewrite)
    ...
    if ~isempty(pos1)
       prev_pdata=strfind(path_to_imagewrite(1:pos1), '/');
       after_pdata=strfind(path_to_imagewrite(pos1:end), '/')+pos1;

       % Check if e.g. bla/blub/5/pdata/4/acqp
       pos2=strfind(path_to_imagewrite(after_pdata:end), '/');
       ...
       second_path_part=['/', expno, '/pdata/', procno]; %e.g. /5/pdata/4
    else
