...
% All Rights Reserved
%
% $Id: bruker_writeVisu.m,v 1.2 2013/05/24 13:29:27 haas Exp $
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
try
    FileID=fopen([writepath, '/visu_pars'],'wb');
catch
    FileID = -1;
end
if FileID == -1
    error('Cannot create 2dseq file. Problem opening file %s.',[writepath, '/visu_pars']);
end
