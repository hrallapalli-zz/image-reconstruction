...
% All Rights Reserved
%
% $Id: bruker_Reco.m,v 1.3 2013/05/24 13:29:27 haas Exp $
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if iscell(Reco.RECO_ft_mode)
    for i=1:length(Reco.RECO_ft_mode)
        if ~strcmp(Reco.RECO_ft_mode{i}, Reco.RECO_ft_mode{1})
           error('It''s not allowed to use different transfomations on different Dimensions')
        end
    end
